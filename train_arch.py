...
parser = argparse.ArgumentParser("training GUI-data")
...
parser.add_argument('--auxiliary_weight', type=float, default=0, help='weight for auxiliary loss')
...
def main():
    ...
    data_dir = os.path.join(args.tmp_data_dir, 'GUI-data')
