...
parser = argparse.ArgumentParser("widgets")
parser.add_argument('--workers', type=int, default=4, help='number of workers to load dataset')
parser.add_argument('--data', type=str, default='/data/train', help='location of the data corpus')
...
data_dir = os.path.join(args.tmp_data_dir, 'train')
...
def main():
   ...
   # dataset prepare
    #data_dir = os.path.join(args.tmp_data_dir, 'train')
    data_dir2 = data_dir
    traindir = data_dir2 = os.path.join(data_dir, 'train')
    valdir = data_dir2 = os.path.join(data_dir,  'val')
